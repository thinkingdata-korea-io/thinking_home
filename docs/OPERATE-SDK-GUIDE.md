...
> 클라이언트 트리거 작업를 웹사이트에서 팝업으로 표시하는 시스템
...
**역할:** TE 콘솔에서 설정한 "클라이언트 트리거 작업"를 받아오는 역할

### 팝업 모듈 (operate-popup.js)
**역할:** 운영 SDK가 받아온 작업를 예쁜 팝업 UI로 표시
...
| 이벤트 | 시점 | 설명 |
|--------|------|------|
| `ops_receive` | 작업 수신 시 | SDK가 작업를 받았을 때 |
...
### Step 1: 운영 메뉴 접근
1. TE 콘솔 로그인
2. 좌측 메뉴에서 **"운영" → "작업 관리"** 클릭

### Step 2: 새 작업 생성
1. **"새 작업 만들기"** 버튼 클릭
2. 작업 유형: **"클라이언트 트리거"** 선택
...
| 구성요소 | 역할 |
|----------|------|
| **운영 SDK** | TE 콘솔 작업를 받아오는 배달부 |
| **팝업 모듈** | 받아온 작업를 예쁘게 보여주는 디자이너 |
| **TE 콘솔** | 마케터가 작업를 설정하는 컨트롤 타워 |
